...
hl.bind(mainMod .. " + R", hl.dsp.exec_cmd("/home/abxijth/.config/waybar/scripts/launch.sh"))
...
hl.bind(mainMod .. " + SHIFT + W", hl.dsp.exec_cmd("grim -g \"$(slurp -w)\" - | wl-copy && notify-send 'Screenshot' 'Window copied to clipboard'"))
hl.bind("PRINT",                   hl.dsp.exec_cmd("grim - | wl-copy && notify-send 'Screenshot' 'Full screen copied to clipboard'"))
hl.bind(mainMod .. " + PRINT",     hl.dsp.exec_cmd("grim ~/Pictures/Screenshots/$(date +%Y-%m-%d_%H-%M-%S).png && notify-send 'Screenshot' 'Saved to ~/Pictures/Screenshots'"))
